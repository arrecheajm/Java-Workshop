...
@ControllerAdvice  // Creates a global entity that interacts with all controllers
public class StudentRESTExceptionHandler {
    // add exception handling code here
    // add an exception handle using @ExceptionHandler
    @ExceptionHandler
    // ResponseEntity -Exception method handler
    // StudentErrorResponse - Type of the reponse body
